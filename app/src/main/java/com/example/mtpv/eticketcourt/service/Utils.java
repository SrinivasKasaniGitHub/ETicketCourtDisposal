...
public class Utils {
    ...
    String OFFENCE_DT = "offenceDT";
    String ETICKET_REG_NO = "eticketRegNo";

    String TICKET_NO = "eticketNo";
    String E_REG_NO = "regnNo";
    String DL_NO = "dlNO";
    String ADHAR_NO = "aadhaarNO";
    String STC_NO = "stcNO";
    String COURT_DIS_CODE = "courtDispCD";
    String IMPRSN_DAYS = "imprisDays";
    String IMPRSN_FROM = "imprisFrom";
    String IMPRSN_TO = "imprisTo";
    String COURT_FINE = "courtFine";
    String RISING_DETAILS = "risingDetails";
    String COURT_CODE = "courtCD";
    String COURT_ATND_DATE = "coutrAttnDT";
    String VEHCLE_RELSE = "vehRelease";
    String DL_RELSE = "dlRelease";
    String DD_REMARKS = "ddRemarks";
    String P_ID = "pidCD";
